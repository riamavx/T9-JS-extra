...
// Retorne uma nova array com o id do produto, nome, tamanho e preço unitário que terá o acréscimo de 1.15 
// sobre o valor dos produtos. 


//const produtoNovo = produtos.map(produto =>`${produto.id} 'e' ${produto.nome} ${produto.tamanho} ${produto.precoUnitario}`);
const listaDeProdutosNovos = produtos.map(function(produto) {
    return { id: produto.id , nome:produto.nome, tamanho:produto.tamanho, precoUnitario: produto.precoUnitario * 1.15  }; })

console.log(listaDeProdutosNovos);
